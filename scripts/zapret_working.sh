...
log "${Y}=== Рабочий zapret для macOS ===${X}"
...
curl -L -o tpws https://github.com/bol-van/zapret/releases/download/2024.12.19/tpws-macos-arm64 || \
curl -L -o tpws https://github.com/bol-van/zapret/releases/download/2024.12.19/tpws-macos-amd64
...
if [[ ! -f "./tpws" ]] || [[ ! -s "./tpws" ]]; then
    ...
    log "${Y}Создаю простой прокси на Python...${X}"
